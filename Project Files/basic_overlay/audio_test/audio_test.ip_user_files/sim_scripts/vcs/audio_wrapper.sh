...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_19 processing_system7_vip_v1_0_21 xil_defaultlib generic_baseblocks_v2_1_2 axi_register_slice_v2_1_33 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_crossbar_v2_1_34 lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_35 axi_protocol_converter_v2_1_33)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_19 $vlogan_opts -sverilog +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/8c45/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_21 $vlogan_opts -sverilog +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../bd/audio/ip/audio_processing_system7_0_0/sim/audio_processing_system7_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_33 $vlogan_opts +v2k +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_11 $vlogan_opts +v2k +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_32 $vlogan_opts +v2k +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/65ce/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_34 $vlogan_opts +v2k +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_protocol_converter_v2_1_33 $vlogan_opts +v2k +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  "../../../../../../Project\\ Files/basic_overlay/audio_test/audio_test.gen/sources_1/bd/audio/hdl/audio_wrapper.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.audio_wrapper xil_defaultlib.glbl -o audio_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./audio_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key audio_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc audio_wrapper_simv.daidir vcs_lib c.obj)
