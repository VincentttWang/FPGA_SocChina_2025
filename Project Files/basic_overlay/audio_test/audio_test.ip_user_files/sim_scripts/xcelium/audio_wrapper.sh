...
#
# Script generated by Vivado on Thu Nov 27 15:40:31 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : audio_wrapper.sh
...
#
# Usage        : audio_wrapper.sh
#                audio_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                audio_wrapper.sh [-reset_run]
#                audio_wrapper.sh [-reset_log]
#                audio_wrapper.sh [-help]
#
...
#                script (type 'audio_wrapper.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_19 -libname processing_system7_vip_v1_0_21 -libname xil_defaultlib -libname generic_baseblocks_v2_1_2 -libname axi_register_slice_v2_1_33 -libname fifo_generator_v13_2_11 -libname axi_data_fifo_v2_1_32 -libname axi_crossbar_v2_1_34 -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_16 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_35 -libname axi_protocol_converter_v2_1_33 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_19 processing_system7_vip_v1_0_21 xil_defaultlib generic_baseblocks_v2_1_2 axi_register_slice_v2_1_33 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_crossbar_v2_1_34 lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_35 axi_protocol_converter_v2_1_33)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "audio_wrapper.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./audio_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_19 $xmvlog_opts -sv +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/8c45/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_21 $xmvlog_opts -sv +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../bd/audio/ip/audio_processing_system7_0_0/sim/audio_processing_system7_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_11 $xmvlog_opts +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_32 $xmvlog_opts +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../audio_test.gen/sources_1/bd/audio/ipshared/65ce/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_34 $xmvlog_opts +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_33 $xmvlog_opts +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/ec67/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/86fe/hdl" +incdir+"../../../audio_test.gen/sources_1/bd/audio/ipshared/3cbc" +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.audio_wrapper xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.audio_wrapper -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log audio_wrapper_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./audio_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: audio_wrapper.sh [-help]\n\
Usage: audio_wrapper.sh [-step]\n\
Usage: audio_wrapper.sh [-lib_map_path]\n\
Usage: audio_wrapper.sh [-reset_run]\n\
Usage: audio_wrapper.sh [-reset_log]\n\
Usage: audio_wrapper.sh [-keep_index]\n\
Usage: audio_wrapper.sh [-noclean_files]\n\n\
