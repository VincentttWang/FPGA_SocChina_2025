...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_19 processing_system7_vip_v1_0_21 xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_35 generic_baseblocks_v2_1_2 axi_register_slice_v2_1_33 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_crossbar_v2_1_34 axi_protocol_converter_v2_1_33)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.audio xil_defaultlib.glbl -o audio_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./audio_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alan/Learning/FPGA/fpgachina/Audio_migrate/audio_test/audio_test.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key audio_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc audio_simv.daidir vcs_lib c.obj)
