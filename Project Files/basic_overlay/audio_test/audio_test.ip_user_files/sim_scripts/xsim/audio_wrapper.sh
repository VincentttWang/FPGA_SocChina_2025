...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L xpm -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L axi_protocol_converter_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot audio_wrapper xil_defaultlib.audio_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim audio_wrapper -key {Behavioral:sim_1:Functional:audio_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/audio.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_19 processing_system7_vip_v1_0_21 generic_baseblocks_v2_1_2 axi_register_slice_v2_1_33 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_crossbar_v2_1_34 lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_35 axi_protocol_converter_v2_1_33)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb audio_wrapper.wdb xsim.dir libdpi.so)
