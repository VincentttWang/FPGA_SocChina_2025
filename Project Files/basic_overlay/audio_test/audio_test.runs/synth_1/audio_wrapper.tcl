...
synth_design -top audio_wrapper -part xc7z020clg400-1
...
generate_parallel_reports -reports { "report_utilization -file audio_wrapper_utilization_synth.rpt -pb audio_wrapper_utilization_synth.pb"  } 
