...
entity denoise_top_fifo_w1_d8_S is 
    generic (
...
architecture rtl of denoise_top_fifo_w1_d8_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component denoise_top_fifo_w1_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
...
begin
----------------------- Instantiation -----------------------
    U_denoise_top_fifo_w1_d8_S_ShiftReg : denoise_top_fifo_w1_d8_S_ShiftReg
    generic map (
...
entity denoise_top_fifo_w1_d8_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 8);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end denoise_top_fifo_w1_d8_S_ShiftReg;

architecture rtl of denoise_top_fifo_w1_d8_S_ShiftReg is
