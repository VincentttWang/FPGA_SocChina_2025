...
entity denoise_top_fifo_w24_d16_S_x is 
    generic (
...
architecture rtl of denoise_top_fifo_w24_d16_S_x is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component denoise_top_fifo_w24_d16_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 24;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
...
begin
----------------------- Instantiation -----------------------
    U_denoise_top_fifo_w24_d16_S_x_ShiftReg : denoise_top_fifo_w24_d16_S_x_ShiftReg
    generic map (
...
entity denoise_top_fifo_w24_d16_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 24;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end denoise_top_fifo_w24_d16_S_x_ShiftReg;

architecture rtl of denoise_top_fifo_w24_d16_S_x_ShiftReg is
