...
architecture behav of fft_top_fftStage_6 is 
...
attribute shreg_extract : string;
    signal fftStageKernelS2S_6_U0_ap_start : STD_LOGIC;
    signal fftStageKernelS2S_6_U0_ap_done : STD_LOGIC;
    signal fftStageKernelS2S_6_U0_ap_continue : STD_LOGIC;
    signal fftStageKernelS2S_6_U0_ap_idle : STD_LOGIC;
    signal fftStageKernelS2S_6_U0_ap_ready : STD_LOGIC;
    signal fftStageKernelS2S_6_U0_fftOutData_local2_read : STD_LOGIC;
    signal fftStageKernelS2S_6_U0_fftOutData_local_din : STD_LOGIC_VECTOR (63 downto 0);
    signal fftStageKernelS2S_6_U0_fftOutData_local_write : STD_LOGIC;
    signal streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_start : STD_LOGIC;
    signal streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_done : STD_LOGIC;
    signal streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_continue : STD_LOGIC;
    signal streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_idle : STD_LOGIC;
    signal streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_ready : STD_LOGIC;
    signal streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_fftOutData_local_read : STD_LOGIC;
    signal streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_fftOutData_local2_din : STD_LOGIC_VECTOR (63 downto 0);
    signal streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_fftOutData_local2_write : STD_LOGIC;
    signal ap_sync_reg_streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_start : STD_LOGIC := '0';
    signal fftStage_7_U0_fftOutData_local2_read : STD_LOGIC;
    signal fftStage_7_U0_outD_0_din : STD_LOGIC_VECTOR (31 downto 0);
    signal fftStage_7_U0_outD_0_write : STD_LOGIC;
    signal fftStage_7_U0_outD_1_din : STD_LOGIC_VECTOR (31 downto 0);
    signal fftStage_7_U0_outD_1_write : STD_LOGIC;
    signal fftStage_7_U0_ap_start : STD_LOGIC;
    signal fftStage_7_U0_ap_done : STD_LOGIC;
    signal fftStage_7_U0_ap_ready : STD_LOGIC;
    signal fftStage_7_U0_ap_idle : STD_LOGIC;
    signal fftStage_7_U0_ap_continue : STD_LOGIC;
    signal ap_sync_reg_fftStage_7_U0_ap_start : STD_LOGIC := '0';
    ...
    component fft_top_fftStageKernelS2S_6 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fft_top_streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fft_top_fftStage_7 IS
    port (
        fftOutData_local2_dout : IN STD_LOGIC_VECTOR (63 downto 0);
        fftOutData_local2_empty_n : IN STD_LOGIC;
        fftOutData_local2_read : OUT STD_LOGIC;
    ...
    component fft_top_fifo_w64_d8_D_x8 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    fftStageKernelS2S_6_U0 : component fft_top_fftStageKernelS2S_6
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0 : component fft_top_streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    fftStage_7_U0 : component fft_top_fftStage_7
    port map (
    ...
    fftOutData_local_U : component fft_top_fifo_w64_d8_D_x8
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    fftOutData_local21_U : component fft_top_fifo_w64_d8_D_x8
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_fftStage_7_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_fftStage_7_U0_ap_start <= ap_const_logic_0;
            else
                if ((ap_start = ap_const_logic_1)) then 
                    ap_sync_reg_fftStage_7_U0_ap_start <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_start <= ap_const_logic_0;
            else
                if ((ap_start = ap_const_logic_1)) then 
                    ap_sync_reg_streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_start <= ap_const_logic_1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_done <= fftStage_7_U0_ap_done;
    ap_idle <= (streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_idle and fftStage_7_U0_ap_idle and fftStageKernelS2S_6_U0_ap_idle);
    ap_ready <= fftStageKernelS2S_6_U0_ap_ready;
    fftOutData_local2_read <= fftStageKernelS2S_6_U0_fftOutData_local2_read;
    fftStageKernelS2S_6_U0_ap_continue <= ap_const_logic_1;
    fftStageKernelS2S_6_U0_ap_start <= ap_start;
    fftStage_7_U0_ap_continue <= ap_continue;
    fftStage_7_U0_ap_start <= (ap_sync_reg_fftStage_7_U0_ap_start or ap_start);
    outD_0_din <= fftStage_7_U0_outD_0_din;
    outD_0_write <= fftStage_7_U0_outD_0_write;
    outD_1_din <= fftStage_7_U0_outD_1_din;
    outD_1_write <= fftStage_7_U0_outD_1_write;
    streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_continue <= ap_const_logic_1;
    streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_start <= (ap_sync_reg_streamingDataCommutor_complex_ap_fixed_16_10_5_3_0_U0_ap_start or ap_start);
end behav;
