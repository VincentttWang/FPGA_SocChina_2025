...
entity fft_top_streamingDataCommutor_complex_ap_fixed_16_7_5_3_0_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_top_streamingDataCommutor_complex_ap_fixed_16_7_5_3_0_s is 
...
attribute shreg_extract : string;
    ...
    signal delay_line_stall_1_load_reg_514 : STD_LOGIC_VECTOR (0 downto 0);
    signal delay_line_stall_1_load_reg_514_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal control_count_1 : STD_LOGIC_VECTOR (0 downto 0) := "0";
    signal control_bits_1 : STD_LOGIC_VECTOR (0 downto 0) := "0";
    signal pf_count_13 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    signal sample_in_read_count_1 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal delay_line_stall_1 : STD_LOGIC_VECTOR (0 downto 0) := "0";
    signal delayline_30_ce0 : STD_LOGIC;
    signal delayline_30_we0 : STD_LOGIC;
    signal delayline_30_q0 : STD_LOGIC_VECTOR (32 downto 0);
    signal control_delayline_1_ce0 : STD_LOGIC;
    signal control_delayline_1_we0 : STD_LOGIC;
    signal control_delayline_1_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal delayline_29_ce0 : STD_LOGIC;
    signal delayline_29_we0 : STD_LOGIC;
    signal delayline_29_q0 : STD_LOGIC_VECTOR (32 downto 0);
    ...
    signal delay_line_stall_1_load_load_fu_223_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln79_5_fu_433_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal select_ln79_5_reg_550 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_valid_3_reg_182 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_3_reg_182 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_real_3_reg_206 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_3_reg_206 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal control_bits_20_fu_405_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln68_6_fu_449_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln68_5_fu_425_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal select_ln68_fu_409_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal valid_flag_fu_477_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln79_6_fu_441_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    delayline_30_U : component fft_top_streamingDataCommutor_complex_ap_fixed_16_1_5_3_0_4_delayline_24_SHIFTREG_AUTncg
    generic map (
        DataWidth => 33,
        AddressRange => 16,
        AddressWidth => 4)
    port map (
        ...
        ce0 => delayline_30_ce0,
        we0 => delayline_30_we0,
        d0 => p_2_fu_345_p4,
        q0 => delayline_30_q0);

    control_delayline_1_U : component fft_top_streamingDataCommutor_complex_ap_fixed_16_1_5_3_0_4_control_delayline_3_SHIFTocq
    generic map (
        DataWidth => 32,
        AddressRange => 16,
        AddressWidth => 4)
    port map (
        ...
        reset => ap_rst,
        address0 => ap_const_lv4_F,
        ce0 => control_delayline_1_ce0,
        we0 => control_delayline_1_we0,
        d0 => zext_ln66_fu_391_p1,
        q0 => control_delayline_1_q0);

    delayline_29_U : component fft_top_streamingDataCommutor_complex_ap_fixed_16_1_5_3_0_4_delayline_24_SHIFTREG_AUTncg
    generic map (
        DataWidth => 33,
        AddressRange => 16,
        AddressWidth => 4)
    port map (
        ...
        reset => ap_rst,
        address0 => ap_const_lv4_F,
        ce0 => delayline_29_ce0,
        we0 => delayline_29_we0,
        d0 => p_3_fu_457_p4,
        q0 => delayline_29_q0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_206)) then
                if (((fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_0) and (delay_line_stall_1_load_load_fu_223_p1 = ap_const_lv1_0))) then 
    ...
    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_206)) then
                if (((fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_0) and (delay_line_stall_1_load_load_fu_223_p1 = ap_const_lv1_0))) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195 <= ap_const_lv16_0;
                elsif ((fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_1)) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195 <= fftOutData_local_dout(31 downto 16);
                elsif ((ap_const_boolean_1 = ap_const_boolean_1)) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195 <= ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195;
                end if;
            end if; 
        end if;
    end process;

    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_3_reg_206_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_206)) then
                if (((fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_0) and (delay_line_stall_1_load_load_fu_223_p1 = ap_const_lv1_0))) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_3_reg_206 <= ap_const_lv16_0;
                elsif ((fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_1)) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_3_reg_206 <= trunc_ln238_fu_227_p1;
                elsif ((ap_const_boolean_1 = ap_const_boolean_1)) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_3_reg_206 <= ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_real_3_reg_206;
                end if;
            end if; 
        end if;
    end process;

    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_3_reg_182_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_206)) then
                if (((fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_0) and (delay_line_stall_1_load_load_fu_223_p1 = ap_const_lv1_0))) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_3_reg_182 <= ap_const_lv1_0;
                elsif ((fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_1)) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_3_reg_182 <= ap_const_lv1_1;
                elsif ((ap_const_boolean_1 = ap_const_boolean_1)) then 
                    ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_3_reg_182 <= ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_valid_3_reg_182;
                end if;
            end if; 
        end if;
    end process;

    pf_count_13_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_207)) then
                if ((icmp_ln243_fu_275_p2 = ap_const_lv1_1)) then 
                    pf_count_13 <= ap_const_lv4_0;
                elsif ((icmp_ln243_fu_275_p2 = ap_const_lv1_0)) then 
                    pf_count_13 <= add_ln247_fu_281_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                delay_line_stall_1_load_reg_514 <= delay_line_stall_1;
                delay_line_stall_1_load_reg_514_pp0_iter1_reg <= delay_line_stall_1_load_reg_514;
                ...
                select_ln79_5_reg_550 <= select_ln79_5_fu_433_p3;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                control_bits_1 <= control_count_1;
                delay_line_stall_1 <= icmp_ln256_fu_321_p2;
                sample_in_read_count_1 <= add_ln260_fu_315_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (fifo_has_next_sample_nbreadreq_fu_110_p3 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (icmp_ln243_fu_275_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                control_count_1 <= xor_ln251_fu_299_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln247_fu_281_p2 <= std_logic_vector(unsigned(pf_count_13) + unsigned(ap_const_lv4_1));
    add_ln260_fu_315_p2 <= std_logic_vector(unsigned(sample_in_read_count_1) + unsigned(ap_const_lv9_1));
    and_ln297_fu_485_p2 <= (valid_flag_fu_477_p3 and select_ln79_6_fu_441_p3);
    ...
    ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195 <= "XXXXXXXXXXXXXXXX";
    ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_real_3_reg_206 <= "XXXXXXXXXXXXXXXX";
    ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_valid_3_reg_182 <= "X";

    ap_predicate_op76_write_state4_assign_proc : process(delay_line_stall_1_load_reg_514_pp0_iter1_reg, and_ln297_reg_555, fifo_has_next_sample_reg_505_pp0_iter1_reg)
    begin
                ap_predicate_op76_write_state4 <= (((fifo_has_next_sample_reg_505_pp0_iter1_reg = ap_const_lv1_1) and (ap_const_lv1_1 = and_ln297_reg_555)) or ((delay_line_stall_1_load_reg_514_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_lv1_1 = and_ln297_reg_555)));
    end process;
    ...
    control_bits_20_fu_405_p1 <= control_delayline_1_q0(1 - 1 downto 0);

    control_delayline_1_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_1_load_reg_514, fifo_has_next_sample_reg_505, ap_block_pp0_stage0_11001_grp1, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_505 = ap_const_lv1_1) or (delay_line_stall_1_load_reg_514 = ap_const_lv1_0)))) then 
            control_delayline_1_ce0 <= ap_const_logic_1;
        else 
            control_delayline_1_ce0 <= ap_const_logic_0;
        end if; 
    end process;


    control_delayline_1_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_1_load_reg_514, fifo_has_next_sample_reg_505, ap_block_pp0_stage0_11001_grp1, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_505 = ap_const_lv1_1) or (delay_line_stall_1_load_reg_514 = ap_const_lv1_0)))) then 
            control_delayline_1_we0 <= ap_const_logic_1;
        else 
            control_delayline_1_we0 <= ap_const_logic_0;
        end if; 
    end process;

    delay_line_stall_1_load_load_fu_223_p1 <= delay_line_stall_1;

    delayline_29_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_1_load_reg_514, fifo_has_next_sample_reg_505, ap_block_pp0_stage0_11001_grp1, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_505 = ap_const_lv1_1) or (delay_line_stall_1_load_reg_514 = ap_const_lv1_0)))) then 
            delayline_29_ce0 <= ap_const_logic_1;
        else 
            delayline_29_ce0 <= ap_const_logic_0;
        end if; 
    end process;


    delayline_29_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_1_load_reg_514, fifo_has_next_sample_reg_505, ap_block_pp0_stage0_11001_grp1, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_505 = ap_const_lv1_1) or (delay_line_stall_1_load_reg_514 = ap_const_lv1_0)))) then 
            delayline_29_we0 <= ap_const_logic_1;
        else 
            delayline_29_we0 <= ap_const_logic_0;
        end if; 
    end process;


    delayline_30_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_1_load_reg_514, fifo_has_next_sample_reg_505, ap_block_pp0_stage0_11001_grp1, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_505 = ap_const_lv1_1) or (delay_line_stall_1_load_reg_514 = ap_const_lv1_0)))) then 
            delayline_30_ce0 <= ap_const_logic_1;
        else 
            delayline_30_ce0 <= ap_const_logic_0;
        end if; 
    end process;


    delayline_30_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, delay_line_stall_1_load_reg_514, fifo_has_next_sample_reg_505, ap_block_pp0_stage0_11001_grp1, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((fifo_has_next_sample_reg_505 = ap_const_lv1_1) or (delay_line_stall_1_load_reg_514 = ap_const_lv1_0)))) then 
            delayline_30_we0 <= ap_const_logic_1;
        else 
            delayline_30_we0 <= ap_const_logic_0;
        end if; 
    end process;
    ...
    fftOutData_local2_din <= ((select_ln79_5_reg_550 & select_ln79_reg_545) & trunc_ln300_reg_559);
    ...
    icmp_ln243_fu_275_p2 <= "1" when (pf_count_13 = ap_const_lv4_F) else "0";
    icmp_ln256_fu_321_p2 <= "0" when (sample_in_read_count_1 = ap_const_lv9_1FF) else "1";
    p_2_fu_345_p4 <= ((ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_3_reg_182 & ap_phi_reg_pp0_iter1_arrayidx_0_1_0_0_0_load_i227_reg_160) & ap_phi_reg_pp0_iter1_arrayidx_0_0_0_0_0_load_i226_reg_171);
    p_3_fu_457_p4 <= ((select_ln68_6_fu_449_p3 & select_ln68_5_fu_425_p3) & select_ln68_fu_409_p3);
    select_ln68_5_fu_425_p3 <= 
        temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 when (control_bits_1(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195;
    select_ln68_6_fu_449_p3 <= 
        temp_tagged_mux_chain_input_valid_fu_379_p3 when (control_bits_1(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_3_reg_182;
    select_ln68_fu_409_p3 <= 
        temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 when (control_bits_1(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_3_reg_206;
    select_ln79_5_fu_433_p3 <= 
        temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 when (control_bits_20_fu_405_p1(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_3_reg_195;
    select_ln79_6_fu_441_p3 <= 
        temp_tagged_mux_chain_input_valid_fu_379_p3 when (control_bits_20_fu_405_p1(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_3_reg_182;
    select_ln79_fu_417_p3 <= 
        temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 when (control_bits_20_fu_405_p1(0) = '1') else 
        ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_3_reg_206;
    t_fu_217_p2 <= std_logic_vector(unsigned(ap_phi_mux_t17_phi_fu_150_p6) + unsigned(ap_const_lv10_1));
    temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 <= delayline_30_q0(31 downto 16);
    temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 <= delayline_30_q0(16 - 1 downto 0);
    temp_tagged_mux_chain_input_valid_fu_379_p3 <= delayline_30_q0(32 downto 32);
    trunc_ln238_fu_227_p1 <= fftOutData_local_dout(16 - 1 downto 0);
    trunc_ln300_fu_491_p1 <= delayline_29_q0(32 - 1 downto 0);
    valid_flag_fu_477_p3 <= delayline_29_q0(32 downto 32);
    xor_ln251_fu_299_p2 <= (control_count_1 xor ap_const_lv1_1);
    zext_ln66_fu_391_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(control_bits_1),32));
end behav;
