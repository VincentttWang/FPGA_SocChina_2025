...
entity fft_top_fifo_w32_d16_S is 
    generic (
...
architecture rtl of fft_top_fifo_w32_d16_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component fft_top_fifo_w32_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
...
begin
----------------------- Instantiation -----------------------
    U_fft_top_fifo_w32_d16_S_ShiftReg : fft_top_fifo_w32_d16_S_ShiftReg
    generic map (
...
entity fft_top_fifo_w32_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end fft_top_fifo_w32_d16_S_ShiftReg;

architecture rtl of fft_top_fifo_w32_d16_S_ShiftReg is
