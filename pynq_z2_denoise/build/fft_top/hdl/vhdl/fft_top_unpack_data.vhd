...
architecture behav of fft_top_unpack_data is 
...
attribute shreg_extract : string;
    ...
    signal i1_fu_60 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
...
begin
    ...
    regslice_both_in_stream_V_data_V_U : component fft_top_regslice_both
    generic map (
        DataWidth => 64)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_keep_V_U : component fft_top_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_strb_V_U : component fft_top_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_stream_V_last_V_U : component fft_top_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(inD_0_full_n, inD_1_full_n, ap_done_reg, ap_start_int, in_stream_TVALID_int_regslice)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or (inD_1_full_n = ap_const_logic_0) or (inD_0_full_n = ap_const_logic_0) or (in_stream_TVALID_int_regslice = ap_const_logic_0) or (ap_start_int = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln16_fu_124_p2)
    begin
        if (((icmp_ln16_fu_124_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    i_fu_118_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i1_load) + unsigned(ap_const_lv9_1));
    icmp_ln16_fu_124_p2 <= "1" when (ap_sig_allocacmp_i1_load = ap_const_lv9_1FF) else "0";

    inD_0_blk_n_assign_proc : process(ap_CS_fsm_state1, inD_0_full_n, ap_done_reg, ap_start_int)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start_int = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            inD_0_blk_n <= inD_0_full_n;
        else 
            inD_0_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    inD_0_din <= in_stream_TDATA_int_regslice(32 - 1 downto 0);

    inD_0_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            inD_0_write <= ap_const_logic_1;
        else 
            inD_0_write <= ap_const_logic_0;
        end if; 
    end process;


    inD_1_blk_n_assign_proc : process(ap_CS_fsm_state1, inD_1_full_n, ap_done_reg, ap_start_int)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start_int = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            inD_1_blk_n <= inD_1_full_n;
        else 
            inD_1_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    inD_1_din <= in_stream_TDATA_int_regslice(63 downto 32);

    inD_1_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            inD_1_write <= ap_const_logic_1;
        else 
            inD_1_write <= ap_const_logic_0;
        end if; 
    end process;
