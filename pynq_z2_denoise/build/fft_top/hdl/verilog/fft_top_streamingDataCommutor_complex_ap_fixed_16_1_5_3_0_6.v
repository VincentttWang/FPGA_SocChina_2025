...
module fft_top_streamingDataCommutor_complex_ap_fixed_16_1_5_3_0_6 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [0:0] delay_line_stall_7_load_reg_514;
reg   [0:0] delay_line_stall_7_load_reg_514_pp0_iter1_reg;
...
reg   [0:0] control_count_7;
reg   [0:0] control_bits_7;
reg   [5:0] pf_count_4;
reg   [8:0] sample_in_read_count_7;
reg   [0:0] delay_line_stall_7;
reg    delayline_5_ce0;
reg    delayline_5_we0;
wire   [32:0] delayline_5_q0;
reg    control_delayline_7_ce0;
reg    control_delayline_7_we0;
wire   [31:0] control_delayline_7_q0;
reg    delayline_4_ce0;
reg    delayline_4_we0;
wire   [32:0] delayline_4_q0;
reg    temp_blk_n;
...
wire   [15:0] select_ln79_19_fu_433_p3;
reg   [15:0] select_ln79_19_reg_550;
...
wire   [0:0] ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_valid_10_reg_182;
reg   [0:0] ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_10_reg_182;
wire   [15:0] ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_imag_10_reg_195;
reg   [15:0] ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_10_reg_195;
wire   [15:0] ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_real_10_reg_206;
reg   [15:0] ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_10_reg_206;
...
#0 control_count_7 = 1'd0;
#0 control_bits_7 = 1'd0;
#0 pf_count_4 = 6'd0;
#0 sample_in_read_count_7 = 9'd0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_220)) begin
        if (((fifo_has_next_sample_nbreadreq_fu_110_p3 == 1'd0) & (delay_line_stall_7_load_load_fu_223_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_10_reg_195 <= 16'd0;
        end else if ((fifo_has_next_sample_nbreadreq_fu_110_p3 == 1'd1)) begin
            ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_10_reg_195 <= {{temp_dout[31:16]}};
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_220)) begin
        if (((fifo_has_next_sample_nbreadreq_fu_110_p3 == 1'd0) & (delay_line_stall_7_load_load_fu_223_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_10_reg_206 <= 16'd0;
        end else if ((fifo_has_next_sample_nbreadreq_fu_110_p3 == 1'd1)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_220)) begin
        if (((fifo_has_next_sample_nbreadreq_fu_110_p3 == 1'd0) & (delay_line_stall_7_load_load_fu_223_p1 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_10_reg_182 <= 1'd0;
        end else if ((fifo_has_next_sample_nbreadreq_fu_110_p3 == 1'd1)) begin
            ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_10_reg_182 <= 1'd1;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_7_load_reg_514 == 1'd0)))) begin
        control_delayline_7_ce0 = 1'd1;
    end else begin
        control_delayline_7_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_7_load_reg_514 == 1'd0)))) begin
        control_delayline_7_we0 = 1'd1;
    end else begin
        control_delayline_7_we0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_7_load_reg_514 == 1'd0)))) begin
        delayline_4_ce0 = 1'd1;
    end else begin
        delayline_4_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_7_load_reg_514 == 1'd0)))) begin
        delayline_4_we0 = 1'd1;
    end else begin
        delayline_4_we0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_7_load_reg_514 == 1'd0)))) begin
        delayline_5_ce0 = 1'd1;
    end else begin
        delayline_5_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_7_load_reg_514 == 1'd0)))) begin
        delayline_5_we0 = 1'd1;
    end else begin
        delayline_5_we0 = 1'b0;
    end
end
...
assign add_ln247_fu_281_p2 = (pf_count_4 + 6'd1);

assign add_ln260_fu_315_p2 = (sample_in_read_count_7 + 9'd1);

assign and_ln297_fu_485_p2 = (valid_flag_fu_477_p3 & select_ln79_20_fu_441_p3);
...
assign ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_imag_10_reg_195 = 'bx;

assign ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_sample_M_real_10_reg_206 = 'bx;

assign ap_phi_reg_pp0_iter0_temp_tagged_mux_chain_input_valid_10_reg_182 = 'bx;

always @ (*) begin
    ap_predicate_op76_write_state4 = (((fifo_has_next_sample_reg_505_pp0_iter1_reg == 1'd1) & (1'd1 == and_ln297_reg_555)) | ((delay_line_stall_7_load_reg_514_pp0_iter1_reg == 1'd0) & (1'd1 == and_ln297_reg_555)));
end

assign ap_ready = internal_ap_ready;

assign control_bits_29_fu_405_p1 = control_delayline_7_q0[0:0];
...
assign icmp_ln243_fu_275_p2 = ((pf_count_4 == 6'd63) ? 1'b1 : 1'b0);

assign icmp_ln256_fu_321_p2 = ((sample_in_read_count_7 != 9'd511) ? 1'b1 : 1'b0);

assign p_04_fu_345_p4 = {{{ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_10_reg_182}, {ap_phi_reg_pp0_iter1_arrayidx_0_1_0_0_0_load_i227_reg_160}}, {ap_phi_reg_pp0_iter1_arrayidx_0_0_0_0_0_load_i226_reg_171}};

assign p_05_fu_457_p4 = {{{select_ln68_20_fu_449_p3}, {select_ln68_19_fu_425_p3}}, {select_ln68_fu_409_p3}};

assign select_ln68_19_fu_425_p3 = ((control_bits_7[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_10_reg_195);

assign select_ln68_20_fu_449_p3 = ((control_bits_7[0:0] == 1'b1) ? temp_tagged_mux_chain_input_valid_fu_379_p3 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_10_reg_182);

assign select_ln68_fu_409_p3 = ((control_bits_7[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_10_reg_206);

assign select_ln79_19_fu_433_p3 = ((control_bits_29_fu_405_p1[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_10_reg_195);

assign select_ln79_20_fu_441_p3 = ((control_bits_29_fu_405_p1[0:0] == 1'b1) ? temp_tagged_mux_chain_input_valid_fu_379_p3 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_10_reg_182);

assign select_ln79_fu_417_p3 = ((control_bits_29_fu_405_p1[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_10_reg_206);

assign start_out = real_start;

assign t_fu_217_p2 = (ap_phi_mux_t17_phi_fu_150_p6 + 10'd1);

assign temp1_din = {{{select_ln79_19_reg_550}, {select_ln79_reg_545}}, {trunc_ln300_reg_559}};

assign temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 = {{delayline_5_q0[31:16]}};

assign temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 = delayline_5_q0[15:0];

assign temp_tagged_mux_chain_input_valid_fu_379_p3 = delayline_5_q0[32'd32];

assign trunc_ln238_fu_227_p1 = temp_dout[15:0];

assign trunc_ln300_fu_491_p1 = delayline_4_q0[31:0];

assign valid_flag_fu_477_p3 = delayline_4_q0[32'd32];

assign xor_ln251_fu_299_p2 = (control_count_7 ^ 1'd1);

assign zext_ln66_fu_391_p1 = control_bits_7;

endmodule //fft_top_streamingDataCommutor_complex_ap_fixed_16_1_5_3_0_6
