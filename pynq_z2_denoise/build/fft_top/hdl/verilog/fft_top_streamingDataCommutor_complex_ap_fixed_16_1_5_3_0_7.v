...
module fft_top_streamingDataCommutor_complex_ap_fixed_16_1_5_3_0_7 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [0:0] delay_line_stall_9_load_reg_514;
reg   [0:0] delay_line_stall_9_load_reg_514_pp0_iter1_reg;
...
reg   [0:0] control_count_9;
reg   [0:0] control_bits_9;
reg   [6:0] pf_count_6;
reg   [8:0] sample_in_read_count_9;
reg   [0:0] delay_line_stall_9;
reg    delayline_10_ce0;
reg    delayline_10_we0;
wire   [32:0] delayline_10_q0;
reg    control_delayline_9_ce0;
reg    control_delayline_9_we0;
wire   [31:0] control_delayline_9_q0;
reg    delayline_9_ce0;
reg    delayline_9_we0;
wire   [32:0] delayline_9_q0;
reg    temp_blk_n;
...
wire   [0:0] control_bits_28_fu_405_p1;
...
#0 control_count_9 = 1'd0;
#0 control_bits_9 = 1'd0;
#0 pf_count_6 = 7'd0;
#0 sample_in_read_count_9 = 9'd0;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_9_load_reg_514 == 1'd0)))) begin
        control_delayline_9_ce0 = 1'd1;
    end else begin
        control_delayline_9_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_9_load_reg_514 == 1'd0)))) begin
        control_delayline_9_we0 = 1'd1;
    end else begin
        control_delayline_9_we0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_9_load_reg_514 == 1'd0)))) begin
        delayline_10_ce0 = 1'd1;
    end else begin
        delayline_10_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_9_load_reg_514 == 1'd0)))) begin
        delayline_10_we0 = 1'd1;
    end else begin
        delayline_10_we0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_9_load_reg_514 == 1'd0)))) begin
        delayline_9_ce0 = 1'd1;
    end else begin
        delayline_9_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & ((fifo_has_next_sample_reg_505 == 1'd1) | (delay_line_stall_9_load_reg_514 == 1'd0)))) begin
        delayline_9_we0 = 1'd1;
    end else begin
        delayline_9_we0 = 1'b0;
    end
end
...
assign add_ln247_fu_281_p2 = (pf_count_6 + 7'd1);

assign add_ln260_fu_315_p2 = (sample_in_read_count_9 + 9'd1);
...
always @ (*) begin
    ap_predicate_op76_write_state4 = (((fifo_has_next_sample_reg_505_pp0_iter1_reg == 1'd1) & (1'd1 == and_ln297_reg_555)) | ((delay_line_stall_9_load_reg_514_pp0_iter1_reg == 1'd0) & (1'd1 == and_ln297_reg_555)));
end

assign ap_ready = internal_ap_ready;

assign control_bits_28_fu_405_p1 = control_delayline_9_q0[0:0];
...
assign icmp_ln243_fu_275_p2 = ((pf_count_6 == 7'd127) ? 1'b1 : 1'b0);

assign icmp_ln256_fu_321_p2 = ((sample_in_read_count_9 != 9'd511) ? 1'b1 : 1'b0);
...
assign select_ln68_17_fu_425_p3 = ((control_bits_9[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_9_reg_195);

assign select_ln68_18_fu_449_p3 = ((control_bits_9[0:0] == 1'b1) ? temp_tagged_mux_chain_input_valid_fu_379_p3 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_9_reg_182);

assign select_ln68_fu_409_p3 = ((control_bits_9[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_9_reg_206);

assign select_ln79_17_fu_433_p3 = ((control_bits_28_fu_405_p1[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_imag_9_reg_195);

assign select_ln79_18_fu_441_p3 = ((control_bits_28_fu_405_p1[0:0] == 1'b1) ? temp_tagged_mux_chain_input_valid_fu_379_p3 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_valid_9_reg_182);

assign select_ln79_fu_417_p3 = ((control_bits_28_fu_405_p1[0:0] == 1'b1) ? temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 : ap_phi_reg_pp0_iter1_temp_tagged_mux_chain_input_sample_M_real_9_reg_206);
...
assign temp_tagged_mux_chain_input_sample_M_imag_fu_369_p4 = {{delayline_10_q0[31:16]}};

assign temp_tagged_mux_chain_input_sample_M_real_fu_365_p1 = delayline_10_q0[15:0];

assign temp_tagged_mux_chain_input_valid_fu_379_p3 = delayline_10_q0[32'd32];

assign trunc_ln238_fu_227_p1 = temp_dout[15:0];

assign trunc_ln300_fu_491_p1 = delayline_9_q0[31:0];

assign valid_flag_fu_477_p3 = delayline_9_q0[32'd32];

assign xor_ln251_fu_299_p2 = (control_count_9 ^ 1'd1);

assign zext_ln66_fu_391_p1 = control_bits_9;

endmodule //fft_top_streamingDataCommutor_complex_ap_fixed_16_1_5_3_0_7
