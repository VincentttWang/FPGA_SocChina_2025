...
always @ (*) begin
    if (((icmp_ln16_fu_124_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | (inD_1_full_n == 1'b0) | (inD_0_full_n == 1'b0) | (in_stream_TVALID_int_regslice == 1'b0) | (ap_start_int == 1'b0));
end
...
assign i_fu_118_p2 = (ap_sig_allocacmp_i1_load + 9'd1);

assign icmp_ln16_fu_124_p2 = ((ap_sig_allocacmp_i1_load == 9'd511) ? 1'b1 : 1'b0);

assign inD_0_din = in_stream_TDATA_int_regslice[31:0];

assign inD_1_din = {{in_stream_TDATA_int_regslice[63:32]}};

assign in_stream_TREADY = regslice_both_in_stream_V_data_V_U_ack_in;

assign start_out = real_start;

endmodule //fft_top_unpack_data
