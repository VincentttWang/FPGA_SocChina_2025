...
#ifndef _audio_system_xlconcat_0_0_core_h_
#define _audio_system_xlconcat_0_0_core_h_
...
class audio_system_xlconcat_0_0_core : public sc_module 
{
    public: 
       audio_system_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(audio_system_xlconcat_0_0_core);
    ...
    virtual ~audio_system_xlconcat_0_0_core() = default;
